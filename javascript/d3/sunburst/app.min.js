!function () {
    ...
    var i = 840, l = i, o = i / 2, d = d3.scale.linear().range([0, 2 * Math.PI]), u = d3.scale.pow().exponent(1.3).domain([0, 1]).range([0, o]), c = 5, s = 1e3, h = d3.select("#vis");
    h.select("img").remove();
    ...
    d3.json("bank.json", function (r, i) {
        function l(n) {
